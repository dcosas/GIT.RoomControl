...
;* Date/Time created: Tue Oct 27 17:18:44 2015                                *
;******************************************************************************
...
;	C:\ti\ccsv6\tools\compiler\ti-cgt-arm_5.2.5\bin\armacpia.exe -@C:\\Users\\DCOSAS~1.SAG\\AppData\\Local\\Temp\\1175612 
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../timers.c",line 40,column 5,is_stmt,isa 1
;----------------------------------------------------------------------
;  40 | if(!g_bFeedWatchdog)//if watchdog not fed, restart the sytem, else kick
;     |  dog                                                                   
;----------------------------------------------------------------------
...
;* --------------------------------------------------------------------------*
	.dwpsn	file "../timers.c",line 42,column 6,is_stmt,isa 1
;----------------------------------------------------------------------
;  42 | if(!g_bWatchdogTimeoutMsgSent)                                         
;----------------------------------------------------------------------
        LDR       A1, $C$CON2           ; [DPU_3_PIPE] |42| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |42| 
        CBNZ      A1, ||$C$L2||         ; [] 
...
;----------------------------------------------------------------------
;  45 | g_bWatchdogTimeoutMsgSent = true;                                      
;----------------------------------------------------------------------
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |45| 
        MOVS      A1, #1                ; [DPU_3_PIPE] |45| 
        STRB      A1, [A2, #0]          ; [DPU_3_PIPE] |45| 
	.dwpsn	file "../timers.c",line 46,column 7,is_stmt,isa 1
;----------------------------------------------------------------------
;  46 | IntMasterEnable();                                                     
;----------------------------------------------------------------------
...
;  48 | return;                                                                
;----------------------------------------------------------------------
        B         ||$C$L2||             ; [DPU_3_PIPE] |48| 
        ; BRANCH OCCURS {||$C$L2||}      ; [] |48| 
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../timers.c",line 51,column 5,is_stmt,isa 1
;----------------------------------------------------------------------
;  51 | ROM_WatchdogIntClear(WATCHDOG0_BASE);                                  
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  64 | ROM_SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOA);                       
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  65 | ROM_SysCtlPeripheralEnable(SYSCTL_PERIPH_UART0);                       
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  66 | ROM_GPIOPinTypeUART(GPIO_PORTA_BASE, GPIO_PIN_0 | GPIO_PIN_1);         
;----------------------------------------------------------------------
        LDR       A1, $C$CON7           ; [DPU_3_PIPE] |66| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |66| 
        LDR       A1, [A1, #84]         ; [DPU_3_PIPE] |66| 
...
;----------------------------------------------------------------------
;  67 | UARTClockSourceSet(UART0_BASE, UART_CLOCK_PIOSC);                      
;  68 | //UARTStdioConfig(0, 115200, 16000000);                                
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
;  75 | temp_secondsCounter = g_ui32SecondsCounter;                            
;----------------------------------------------------------------------
...
||$C$SL1||:	.string	"1.0 10.20.15",0
	.align	4
||$C$SL2||:	.string	"Oct 27 2015",0
	.align	4
||$C$SL3||:	.string	"17:18:44",0
;******************************************************************************
;* CONSTANT TABLE                                                             *
;******************************************************************************
	.sect	".text:kick_watchdog"
