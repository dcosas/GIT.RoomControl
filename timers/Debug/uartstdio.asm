...
;* Date/Time created: Wed Oct 28 12:40:23 2015                                *
;******************************************************************************
...
;	C:\ti\ccsv6\tools\compiler\ti-cgt-arm_5.2.5\bin\armacpia.exe -@C:\\Users\\DCOSAS~1.SAG\\AppData\\Local\\Temp\\0856812 
...
;----------------------------------------------------------------------
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |352| 
        LDR       A4, $C$CON2           ; [DPU_3_PIPE] |352| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |352| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |352| 
        LDR       A1, [A1, #16]         ; [DPU_3_PIPE] |352| 
        MOV       A2, A1                ; [DPU_3_PIPE] |352| 
        LDR       A1, [A4, +A3, LSL #2] ; [DPU_3_PIPE] |352| 
$C$DW$12	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$12, DW_AT_low_pc(0x00)
	.dwattr $C$DW$12, DW_AT_TI_call
	.dwattr $C$DW$12, DW_AT_TI_indirect
        BLX       A2                    ; [DPU_3_PIPE] |352| 
        ; CALL OCCURS {}                 ; [] |352| 
        CBZ       A1, ||$C$L1||         ; [] 
...
; 369 | //                                                                     
;----------------------------------------------------------------------
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |365| 
        LDR       A4, $C$CON2           ; [DPU_3_PIPE] |365| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |365| 
        LDR       A3, [SP, #0]          ; [DPU_3_PIPE] |365| 
        LDR       A1, [A1, #24]         ; [DPU_3_PIPE] |365| 
        MOV       A2, A1                ; [DPU_3_PIPE] |365| 
        LDR       A1, [A4, +A3, LSL #2] ; [DPU_3_PIPE] |365| 
...
; 405 | //                                                                     
;----------------------------------------------------------------------
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |370| 
        LDR       A4, $C$CON3           ; [DPU_3_PIPE] |370| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |370| 
        LDR       A2, [SP, #8]          ; [DPU_3_PIPE] |370| 
        LDR       A3, [SP, #4]          ; [DPU_3_PIPE] |370| 
        LDR       A1, [A1, #20]         ; [DPU_3_PIPE] |370| 
        MOV       V1, A1                ; [DPU_3_PIPE] |370| 
        LDR       A1, [A4, #0]          ; [DPU_3_PIPE] |370| 
...
;----------------------------------------------------------------------
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |406| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |406| 
        LDR       A3, $C$CON3           ; [DPU_3_PIPE] |406| 
        LDR       A1, [A1, #28]         ; [DPU_3_PIPE] |406| 
        MOV       A2, A1                ; [DPU_3_PIPE] |406| 
        LDR       A1, [A3, #0]          ; [DPU_3_PIPE] |406| 
...
;----------------------------------------------------------------------
        ...
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |523| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |523| 
        MOV       A3, A1                ; [DPU_3_PIPE] |523| 
        LDR       A1, [A2, #0]          ; [DPU_3_PIPE] |523| 
        MOVS      A2, #13               ; [DPU_3_PIPE] |523| 
$C$DW$23	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$23, DW_AT_low_pc(0x00)
	.dwattr $C$DW$23, DW_AT_TI_call
	.dwattr $C$DW$23, DW_AT_TI_indirect
        BLX       A3                    ; [DPU_3_PIPE] |523| 
        ; CALL OCCURS {}                 ; [] |523| 
;* --------------------------------------------------------------------------*
||$C$L3||:    
...
; 534 | //                                                                     
;----------------------------------------------------------------------
        LDR       A1, $C$CON7           ; [DPU_3_PIPE] |529| 
        LDR       A2, [SP, #0]          ; [DPU_3_PIPE] |529| 
        LDR       A3, [SP, #8]          ; [DPU_3_PIPE] |529| 
        LDR       A4, $C$CON6           ; [DPU_3_PIPE] |529| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |529| 
        LDRB      A2, [A3, +A2]         ; [DPU_3_PIPE] |529| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |529| 
        MOV       A3, A1                ; [DPU_3_PIPE] |529| 
        LDR       A1, [A4, #0]          ; [DPU_3_PIPE] |529| 
...
; 672 | //                                                                     
;----------------------------------------------------------------------
        LDR       A1, $C$CON8           ; [DPU_3_PIPE] |668| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |668| 
        LDR       A3, $C$CON9           ; [DPU_3_PIPE] |668| 
        LDR       A1, [A1, #56]         ; [DPU_3_PIPE] |668| 
        MOV       A2, A1                ; [DPU_3_PIPE] |668| 
        LDR       A1, [A3, #0]          ; [DPU_3_PIPE] |668| 
...
; 755 | //                                                                     
;----------------------------------------------------------------------
        LDR       A1, $C$CON8           ; [DPU_3_PIPE] |749| 
        LDR       A4, $C$CON9           ; [DPU_3_PIPE] |749| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |749| 
        LDRB      A2, [SP, #12]         ; [DPU_3_PIPE] |749| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |749| 
        MOV       A3, A1                ; [DPU_3_PIPE] |749| 
        LDR       A1, [A4, #0]          ; [DPU_3_PIPE] |749| 
...
; 818 | #endif                                                                 
;----------------------------------------------------------------------
        LDR       A1, $C$CON11          ; [DPU_3_PIPE] |817| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |817| 
        LDR       A3, $C$CON12          ; [DPU_3_PIPE] |817| 
        LDR       A1, [A1, #56]         ; [DPU_3_PIPE] |817| 
        MOV       A2, A1                ; [DPU_3_PIPE] |817| 
        LDR       A1, [A3, #0]          ; [DPU_3_PIPE] |817| 
...
$C$DW$54	.dwtag  DW_TAG_variable, DW_AT_name("pcBuf")
	...
	.dwattr $C$DW$54, DW_AT_type(*$C$DW$T$90)
...
$C$DW$62	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$62, DW_AT_TI_call
        ...
        LDR       A3, $C$CON13          ; [DPU_3_PIPE] |1202| 
...
;******************************************************************************
	.sect	".text:UARTwrite"
	.align	4
||$C$CON6||:	.bits	g_ui32Base,32
	.align	4
||$C$CON7||:	.bits	16777236,32
;******************************************************************************
;* STRINGS                                                                    *
;******************************************************************************
	.sect	".text:UARTgets"
...
;******************************************************************************
	.sect	".text:UARTgets"
	.align	4
||$C$CON8||:	.bits	16777236,32
	.align	4
||$C$CON9||:	.bits	g_ui32Base,32
	.align	4
||$C$CON10||:	.bits	bLastWasCR$1,32
;******************************************************************************
;* CONSTANT TABLE                                                             *
;******************************************************************************
	.sect	".text:UARTgetc"
	.align	4
||$C$CON11||:	.bits	16777236,32
	.align	4
||$C$CON12||:	.bits	g_ui32Base,32
;******************************************************************************
;* STRINGS                                                                    *
;******************************************************************************
	.sect	".text:UARTvprintf"
